...
import com.payroc.payrocsdktestapp.ui.devices.DeviceListFragment.OnListFragmentInteractionListener
import com.payroc.payrocsdktestapp.ui.devices.dummy.DummyContent.DummyItem

import kotlinx.android.synthetic.main.fragment_devicelist.view.*
...
class MyDeviceListRecyclerViewAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context)
            .inflate(R.layout.fragment_devicelist, parent, false)
